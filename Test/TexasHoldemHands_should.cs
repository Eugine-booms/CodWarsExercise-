    ...
    public class TexasHoldemHandsTest
    {
        ...
        public void FixedTests()
        {
            //expected: hand name cards input -> hole cards community cards
                 ...
                 SampleTest(("two pair", new[] { "9", "5", "Q" }), new[] { "3♠", "Q♦" }, new[] { "9♠", "9♥", "5♠", "8♣", "5♥" });
            SampleTest(("straight-flush", new[] { "8", "7", "6", "5", "4" }), new[] { "A♣", "8♣" }, new[] { "9♥", "7♣", "4♣", "5♣", "6♣" });
            SampleTest(("full house", new[] { "A", "K" }), new[] { "A♠", "A♦" }, new[] { "K♣", "K♥", "A♥", "Q♥", "K♦" });

            SampleTest(("straight", new[] { "10", "9", "8", "7", "6" }), new[] { "10♥", "9♥" }, new[] { "3♣", "7♥", "8♣", "8♥", "6♠" });
            SampleTest(("straight", new[] { "8", "7", "6", "5", "4" }), new[] { "5♥", "7♣" }, new[] { "6♦", "6♠", "2♣", "8♥", "4♣" });
